...
BOOTANIMATION_PATH := vendor/stayboogy/media/bootanimation

PRODUCT_COPY_FILES += \
    $(BOOTANIMATION_PATH)/bootanimation.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation.zip \
    $(BOOTANIMATION_PATH)/bootanimation-dark.zip:$(TARGET_COPY_OUT_PRODUCT)/media/bootanimation-dark.zip
	
# Custom Audio Files
ALARM_PATH := vendor/stayboogy/media/alarms
NOTIFICATION_PATH := vendor/stayboogy/media/notifications
RINGTONE_PATH := vendor/stayboogy/media/ringtones
